...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private User getModernUser(SocialType socialType, Map<String, Object> map) {
        ...
        String id = null;
        if (socialType.equals(FACEBOOK)) id = String.valueOf(map.get("id"));
        if (socialType.equals(GOOGLE)) id = String.valueOf(map.get("sub"));
    ...
    private User getKakaoUser(Map<String, Object> map) {
        Map<String, Object> propertyMap = (HashMap<String, Object>) map.get("properties");
        return User.builder()
